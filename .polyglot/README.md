...
- **Repository:** `larsbx/objective-review-metasytem`
- **Primary language authority:** Tcl
- **Supporting languages:** Haskell, Lean, Markdown
- **Assigned responsibility:** Skill and policy-language construction
